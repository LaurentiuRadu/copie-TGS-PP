  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "",
        head_cell: "text-muted-foreground rounded-md w-9 text-center font-medium text-[0.8rem]",
        row: "mt-2",
        ...
        day_today: "bg-transparent ring-1 ring-accent text-accent-foreground rounded-md aria-selected:bg-primary aria-selected:text-primary-foreground aria-selected:ring-0",
        day_outside:
