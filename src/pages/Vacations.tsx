...
import { VacationScheduleCalendar } from '@/components/VacationScheduleCalendar';
    ...
    >
      <div className="w-full p-6 md:p-8">
        <Tabs defaultValue="cereri" className="w-full">
          ...
          <TabsContent value="programare" className="space-y-6">
            <VacationScheduleCalendar />
          </TabsContent>
        </Tabs>
      </div>
    </AdminLayout>
